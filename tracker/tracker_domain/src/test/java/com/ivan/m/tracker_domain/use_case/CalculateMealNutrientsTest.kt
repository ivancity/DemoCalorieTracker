...
import com.ivan.m.tracker_domain.model.MealType
...
class CalculateMealNutrientsTest {
    ...
    /**
     * Making sure the setup will run every single time we run the test.
     */
    @Before
    fun setUp() {
        // create a mock version of our Preferences, and relaxed as true to give some empty responses.
        val preferences = mockk<Preferences>(relaxed = true)
        // In this CalculateMealNutrients use case we use only the loadUserInfo function from the
        // Preferences object, thus we only need to mock the result from that function.
        ...
        // Now we can init our use case
        calculateMealNutrients = CalculateMealNutrients(preferences)
    }

    @Test
    fun `Calories for breakfast properly calculated`() {
        // Create some random list of TrackedFoods, randomize some values.
        ...
        // now call the use case that we want to test with the necessary parameter.
